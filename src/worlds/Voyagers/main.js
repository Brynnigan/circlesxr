...
function setupPuzzle2(role) {
    if (role == "control") {
        document.querySelector('#rover-controls').innerHTML = '<a-entity id="rover-buttBase" gltf-model="#rover-buttBase-model" circles-sphere-env-map="src:#space"></a-entity><a-entity id="rover-orangeButt" class="interactive" gltf-model="#rover-orangeButt-model" circles-sphere-env-map="src:#space"></a-entity><a-entity id="rover-greenButt" class="interactive" gltf-model="#rover-greenButt-model" circles-sphere-env-map="src:#space"></a-entity><a-entity id="rover-blueButt" class="interactive" gltf-model="#rover-blueButt-model" circles-sphere-env-map="src:#space"></a-entity>';
    }
    else if (role == "cargo") {
        let controls = document.querySelector('#rover-controls');
        controls.innerHTML = '<a-entity id="rover-topArrow" gltf-model="#rover-arrow-model" class="interactive" circles-sphere-env-map="src:#space" position="0 0 -0.05"></a-entity><a-entity id="rover-rightArrow" class="interactive" gltf-model="#rover-arrow-model" circles-sphere-env-map="src:#space" rotation="0 -90 0" position="0.05 0 0"></a-entity><a-entity id="rover-bottomArrow" class="interactive" gltf-model="#rover-arrow-model" circles-sphere-env-map="src:#space" rotation="0 180 0" position="0 0 0.05"></a-entity><a-entity id="rover-leftArrow" class="interactive" gltf-model="#rover-arrow-model" circles-sphere-env-map="src:#space" rotation="0 90 0" position="-0.05 0 0"></a-entity>';
