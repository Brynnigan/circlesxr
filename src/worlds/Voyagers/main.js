...
function setupPuzzle1(role) {
    ...
    if (role == "control") {
        let temp = '<a-entity id="button-NW-group" position="-12.5 4 -10.5" scale="1 1 1" rotation="90 90 0"> <a-entity id="button-plat-NW"  gltf-model="#button-platform-model" circles-sphere-env-map="src:#space-texture"></a-entity> <a-entity id="NW" class="interactive" gltf-model="#button-model" circles-sphere-env-map="src:#space-texture" animation__mouseenter="property:position.y; from:0; to:-0.11; startEvents:click; dur:1000; easing:easeInOutSine" animation__mouseleave="property:position.y; from:-0.11; to:0; startEvents:click; dur:800; easing:easeInOutSine" shadow></a-entity>></a-entity> </a-entity>';
        ...
        document.querySelector("#buttons").innerHTML = temp;
        document.querySelector('#newPoster').innerHTML = '<a-entity geometry="primitive:plane; width:4.34; height:5.6;" material="src:#poster2-img" position="-12.2 5 8.95" rotation="0 90 0" circles-sphere-env-map="src:#space-texture2"></a-entity>';
        return ["NW", "SE"];
    }
    else if (role == "cargo") {
        ...
        document.querySelector("#buttons").innerHTML = temp;
        document.querySelector('#newPoster').innerHTML = '<a-entity geometry="primitive:plane; width:4.34; height:5.6;" material="src:#poster1-img" position="-12.2 5 8.95"rotation="0 90 0" circles-sphere-env-map="src:#space-texture2"></a-entity>';
        return ["NE", "SW"];
    }
};
...
function setupPuzzle2(role) {
    if (role == "control") {
        document.querySelector('#rover-controls').innerHTML = '<a-entity id="buttBase1" gltf-model="#buttBase-model" circles-sphere-env-map="src:#space-texture"></a-entity> <a-entity id="buttBase2" gltf-model="#buttBase-model" position="-1.3 0 0" circles-sphere-env-map="src:#space-texture"></a-entity> <a-entity id="buttBase3" gltf-model="#buttBase-model" position="1.3 0 0" circles-sphere-env-map="src:#space-texture"></a-entity> <a-entity id="rover-orangeButt" gltf-model="#orangeButt-model" class="interactive" circles-sphere-env-map="src:#space-texture"; animation="startEvents:click; property: scale; dir: alternate; dur: 400; easing: easeInSine; from: 0.96 0.96 0.96; to: 1 1 1"></a-entity> <a-entity id="rover-greenButt" gltf-model="#greenButt-model" class="interactive" position="-1.3 0 0" circles-sphere-env-map="src:#space-texture" animation="startEvents:click; property: scale; dir: alternate; dur: 400; easing: easeInSine; from: 0.96 0.96 0.96; to: 1 1 1"></a-entity> <a-entity id="rover-blueButt" gltf-model="#blueButt-model" class="interactive" position="1.3 0 0" circles-sphere-env-map="src:#space-texture" animation="startEvents:click; property: scale; dir: alternate; dur: 400; easing: easeInSine; from: 0.96 0.96 0.96; to: 1 1 1"></a-entity>';
    }
    else if (role == "cargo") {
...
function setupPuzzle3(role) {
    ...
    if (role == "cargo") {
        document.querySelector('#star-puzzle').innerHTML = '<a-entity geometry="primitive:plane; width:4.34; height:5.6;" material="src:#star-poster1" position="-8 5 -12.2"rotation="0 0 0" circles-sphere-env-map="src:#space-texture2"></a-entity> <a-entity geometry="primitive:plane; width:4.34; height:5.6;" material="src:#star-poster2" position="6 5 -12.2"rotation="0 0 0" circles-sphere-env-map="src:#space-texture2"></a-entity> <a-entity geometry="primitive:plane; width:4.34; height:5.6;" material="src:#star-poster3" position="-12.2 5 -9"rotation="0 90 0" circles-sphere-env-map="src:#space-texture2"></a-entity>';
    }
}
